        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex flex-1 justify-center space-x-8">
            <NavLink 
              to="/collection" 
              className={({ isActive }) => 
                `font-medium uppercase text-gray-700 hover:text-sky-600 transition ${isActive ? 'text-sky-600' : ''}`
              }
            >
              SẢN PHẨM
            </NavLink>
          ...
          <div className="flex items-center space-x-4 h-10 relative">
            ...
            <div className="relative" ref={avatarRef}>
              <img
                src={user?.avatar || avt}
                className="w-8 h-8 cursor-pointer rounded-full border-2 border-gray-300 hover:border-sky-500 transition object-cover"
                alt="Avatar"
